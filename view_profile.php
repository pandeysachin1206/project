...
<div class="grid_3">
  ...
  <div class="container">
   ...
   <div class="breadcrumb1">
     ...
     <ul>        <a href="index.php"><i class="fa fa-home home_1"></i></a>
				...
				<table class="table_working_hours">
		        	...
		        	<tbody>
		        		...
		        		<tr class="opened_1">
							...
							<td class="day_value"><?php echo $fname . " " .$lname; ?></td>					</tr>
					<tr class="opened_1">
				    	...
				    	<div class="col-md-6 basic_1-left">
				    	  ...
				    	  <table class="table_working_hours">
							...
							<tr class="opened">
									...
									<td class="day_value"><?php echo $bodytype;?></td>								</tr>
				    	  ...
				    	  <table class="table_working_hours">
				        	...
				        	<tbody>
				        		...
				        		<tr class="opened">
									...
									<td class="day_value"><?php echo $caste;?></td>								</tr>
				    	...
				    	<div class="col-md-6 basic_1-left">
				    	  <table class="table_working_hours">
							...
							<tr class="opened">
									...
									<td class="day_value closed"><span><?php echo $bros;?></span></td>								</tr>
